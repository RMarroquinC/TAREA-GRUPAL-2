// 7691-23-15921	Marco Antonio Sinto López	
// 7691-23-4765		Eddy Elias Villatoro Gómez	
// 7691-23-23808	Usias Israel Saquic Garcia	
// 7691-23-5879		Rudy Armando Marroquin Carrillo
...
int main() {
    ...
    do {
		...
		// switch con void, llamando a las funciones
        switch(opcion) {
            case 1:
                crearPalabra();
                break;
